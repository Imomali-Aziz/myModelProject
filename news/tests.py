...
class PostModelTest(TestCase):
	def setUp(self):
		Post.objects.create(title='Mavzu', text='mavzu matni', author='muallif')
	...
	def test_text_contents(self):
		...
		self.assertEqual(expected_object_author, 'muallif')

class HomePageViewTest(TestCase):
	def setUp(self):
		Post.objects.create(title='Mavzu 2', text='boshqa mavzu matni', author='ashi muallif')
